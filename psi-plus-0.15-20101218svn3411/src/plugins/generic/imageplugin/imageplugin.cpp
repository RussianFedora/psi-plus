...
, public StanzaSender, public IconFactoryAccessor, public ActiveTabAccessor, public PluginInfoProvider
, public AccountInfoAccessor
{
        Q_OBJECT
        Q_INTERFACES(PsiPlugin ToolbarIconAccessor StanzaSender ActiveTabAccessor
...
void ImagePlugin::fileSelect(){
	...
	if ( file.open(QIODevice::ReadOnly) ) {
	    QByteArray image = file.readAll();
            ...
            QString msgHtml = "<message type=\"chat\" to=\""+jidToSend+"\" id=\""+stanzaSender->uniqueId(account)+"\" ><body>"+tr("Image :)")+"</body><html xmlns=\"http://jabber.org/protocol/xhtml-im\">";
