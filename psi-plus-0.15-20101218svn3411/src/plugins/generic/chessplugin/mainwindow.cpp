...
SelectFigure::SelectFigure(QString player, QWidget *parent)
                : QWidget(parent)
{
...
void ChessWindow::moveRequest(int oldX, int oldY, int newX, int newY, QString figure) {
...
void ChessWindow::loadRequest(QString settings) {
...
void ChessWindow::needNewFigure(QModelIndex index,  QString player) {
    tmpIndex_ = index;
