...
QMultiMap<QModelIndex, int> BoardModel::availableMoves(Figure* figure)
{
...
void BoardModel::updateFigure(QModelIndex index, QString figure)
{
...
void BoardModel::loadSettings(QString settings, bool myLoad) {
    reset();
