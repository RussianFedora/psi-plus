...
QWidget *OptionsTabAppearanceGeneral::widget()
{
	...
	bg_color->addButton(d->pb_cUserText);
	bg_color->addButton(d->pb_cHighlighting);
...
void OptionsTabAppearanceGeneral::applyOptions()
{
	...
	PsiOptions::instance()->setOption("options.ui.look.colors.messages.highlighting", getColor(d->pb_cHighlighting));
	...
	PsiOptions::instance()->setOption("options.ui.look.colors.messages.usertext", getColor(d->pb_cUserText));
}
...
void OptionsTabAppearanceGeneral::restoreOptions()
{
	...
	restoreColor(d->pb_cHighlighting, PsiOptions::instance()->getOption("options.ui.look.colors.messages.highlighting").value<QColor>());
	...
	restoreColor(d->pb_cUserText, PsiOptions::instance()->getOption("options.ui.look.colors.messages.usertext").value<QColor>());
}
