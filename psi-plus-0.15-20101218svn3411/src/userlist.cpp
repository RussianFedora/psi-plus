...
QString UserListItem::findClient(QString name) const
{
	...
	if(name.startsWith("adium"))
		...
		res = "bombus-avalon";
	else if(name.startsWith("jame") || name.startsWith("jabrss") || name.startsWith("pako bot") || name.startsWith("fatal-bot") || name.startsWith("storm") || name.startsWith("sulci") || name.startsWith("sleekbot") || name.startsWith("neutrina") || name.startsWith("yamaneko") || name.startsWith("talisman") || name.contains(QString::fromUtf8(QByteArray::fromHex("efbbbfd0b3d0bed0b2d0bdd0bed0b1d0bed182"))) || name.startsWith(QString::fromUtf8(QByteArray::fromHex("efbbbfcf84ceb1cebbceb9cf82cebcceb1ceb7"))))
		res = "bot";
		...
		res = "qipmobile";
	else if(name.startsWith("qip infium") || name.startsWith("qip 2010"))
		res = "qipinfium";
...
{
	QString str;
	if (v_hPending) str = QString("[%1/%2]").arg(v_pending).arg(v_hPending);
	else if (v_pending) str = QString("[%1]").arg(v_pending);
	return str;
}
